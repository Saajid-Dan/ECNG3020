...
def ict_indicators():
    ...
    for j in range(len(yrs)):
        ...
        for k in range(20):
            ...
            # print(yr, df_fix.iloc[k]['Country'], fix)
            # print(yr, df_mob.iloc[k]['Country'], mob)
            # print(yr, df_per.iloc[k]['Country'], per)
            # print(yr, df_bw.iloc[k]['Country'], bw)
            # print()

            u = indicators(
                year = yrs[j],
                ctry = df_fix.iloc[k]['Country'],
                fix = fix,
                mob = mob,
                per = per,
                bw = bw,
