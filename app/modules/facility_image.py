...
import base64
from app import db
from app.models import Pdb_facility
...
def create_fac_image():
    ...
    fac_ctry = Pdb_facility.query.all()
    ...
    for j in ctry_lst:
        ...
        fac_ = db.session.query(Pdb_facility.lat, Pdb_facility.lon, Pdb_facility.name).filter_by(country=j).all()
        ...
        time.sleep(5)
        # Screenshot the map.
        browser.save_screenshot("./app/static/images/infrastructure/facility/" + j + ".png")
